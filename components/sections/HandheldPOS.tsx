    ...
    <section className="relative overflow-hidden py-20 lg:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          {/* Right - Content */}
          <div className="order-1 space-y-8 lg:order-2 animate-fade-in">
            {/* Badge with Enhanced Glass */}
            <div className="inline-flex items-center gap-2 rounded-full border border-green-300/50 bg-green-100/60 px-5 py-2.5 shadow-lg backdrop-blur-xl">
            ...
            <div className="grid grid-cols-1 gap-4 pt-2 sm:grid-cols-2">
              {[
                ...
                <div
                  key={feature.label}
                  className="group relative overflow-hidden rounded-2xl border border-white/60 bg-white/70 p-5 shadow-xl backdrop-blur-xl transition-all hover:border-green-300 hover:bg-white/80 hover:shadow-2xl animate-fade-in"
            ...
            <div className="pt-4">
              <Link href="/solutions/pos-hardware">
                <button className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-green-600 to-teal-600 px-8 py-4 text-lg font-bold text-white shadow-2xl shadow-green-500/30 transition-all duration-300 hover:shadow-green-500/50 hover:scale-105 active:scale-95">
